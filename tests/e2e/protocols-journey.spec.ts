...
test.describe('Admin protocols staff journey', () => {
  ...
  test('admin creates protocol → imports JSON notes → finalizes (API + UI)', async ({ page }) => {
    const title = buildE2EProtocolTitle();
    const summary = 'E2E-Zusammenfassung: Teamsitzung automatisch importiert, bereit zur Freigabe.';
