...
console.log(
  `${colors.bright}${colors.green}║                    🚀 RevampIT Development Server                     ║${colors.reset}`,
);
console.log(
  `${colors.bright}${colors.green}╚════════════════════════════════════════════════════════════════════════╝${colors.reset}`,
);
console.log('');
console.log(
  `${colors.bright}  PORT    SERVICE           URL                           DESCRIPTION${colors.reset}`,
);
console.log(
...
ports.forEach(({ port, service, url, description }) => {
  ...
  console.log(
    `  ${colors.cyan}${paddedPort}${colors.reset}  ${colors.bright}${paddedService}${colors.reset}  ${colors.yellow}${paddedUrl}${colors.reset}  ${colors.gray}${description}${colors.reset}`,
  );
});
