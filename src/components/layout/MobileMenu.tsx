    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-subtle dark:border-white/6">
        <Button
          ...
          variant="ghost"
          onClick={onClose}
          className="cursor-pointer bg-transparent border-none p-0 h-auto"
        >
          <Logo />
        </Button>
        <Button
      ...
      <MobileMenuFooter session={session} t={t} tTheme={tTheme} onClose={onClose} />
    </Drawer>
  );
}
