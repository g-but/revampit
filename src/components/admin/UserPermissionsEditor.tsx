...
export function UserPermissionsEditor({
  ...
  return (
    <Modal isOpen={true} onClose={onClose} title={t('title')} size="lg">
      <p className="text-sm text-text-secondary -mt-3 mb-4">{userName || userEmail}</p>
        ...
        <div className="mb-6 p-4 bg-action-muted rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-action-text">{t('superAdminLabel')}</p>
                <p className="text-sm text-action">{t('superAdminDescription')}</p>
              </div>
            </div>
            <Button
              variant="ghost"
            ...
            >
              <div
                className={`absolute top-0.5 left-0.5 w-5 h-5 bg-surface-base rounded-full transition-transform ${
          ...
          {isInHardcodedList && (
            <p className="mt-2 text-xs text-action">{t('superAdminHardcoded')}</p>
          )}
        </div>
          ...
          <div className="mb-6 p-4 bg-action-muted rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-action-text">{t('fullAccessLabel')}</p>
                  <p className="text-sm text-action">{t('fullAccessDescription')}</p>
                </div>
              </div>
              <Button
                variant="ghost"
