import { FileText, ScanLine, GraduationCap, Wrench, MapPin } from 'lucide-react';
...
export function buildQuickActions(
  ...
  if (canAccessSection('services')) {
    actions.push({
      ...
      icon: Wrench,
      color:
        'bg-secondary-100 dark:bg-secondary-900/30 text-secondary-600 hover:bg-secondary-200 dark:hover:bg-secondary-900/50',
    });
  }
