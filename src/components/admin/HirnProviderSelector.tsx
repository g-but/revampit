...
interface ProviderMeta {
  ...
  descriptionKey:
    'providerDescriptionOllama' | 'providerDescriptionGroq' | 'providerDescriptionOpenrouter';
  keyName: string;
  keyUrl?: string;
  keyPrefix?: string;
}
...
const CATEGORIES: {
  id: ProviderCategory;
  labelKey: 'categoryLocal' | 'categoryFree';
  descriptionKey: 'categoryLocalDescription' | 'categoryFreeDescription';
}[] = [
        ...
        {currentMeta ? (
          <>
            ...
            <div className="text-left">
              <div className="font-medium text-text-primary">{currentMeta.label}</div>
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-96 bg-surface-base rounded-2xl shadow-xs border border z-50 overflow-hidden">
            ...
            <div className="p-3 bg-surface-raised border-t border-subtle">
              <p className="text-xs text-text-tertiary text-center">{t('footerHint')}</p>
            </div>
          </div>
        </>
      )}
