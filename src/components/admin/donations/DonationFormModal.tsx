        ...
        <div className="flex gap-2 mb-6">
          <Button
            ...
            className={`flex-1 py-2 px-4 rounded-lg flex items-center justify-center gap-2 h-auto ${
              formType === DONATION_TYPES.MONETARY ? '' : 'bg-surface-raised text-text-secondary'
            }`}
          >
          ...
          <Button
            ...
            className={`flex-1 py-2 px-4 rounded-lg flex items-center justify-center gap-2 h-auto ${
              formType === DONATION_TYPES.DEVICE ? '' : 'bg-surface-raised text-text-secondary'
            }`}
          >
          ...
          <FormField
            label={
              <>
                Name des Spenders{' '}
                {selectedUser && (
                  <span className="text-text-muted font-normal">(überschreibt Benutzer)</span>
                )}
              </>
            }
            htmlFor="donor-name"
