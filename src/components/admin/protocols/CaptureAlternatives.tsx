...
const RECORD_TOOLS: ToolLink[] = [
  {
    ...
    desc: 'Linux · GNOME, eingebaut',
    url: 'https://gitlab.gnome.org/GNOME/gnome-sound-recorder',
    oss: true,
  },
  {
    name: 'Audacity',
    desc: 'Linux / macOS / Windows · Open Source',
    url: 'https://www.audacityteam.org/',
    oss: true,
  },
  {
    name: 'OBS Studio',
    desc: 'Linux / macOS / Windows · Open Source (auch Video)',
  ...
  },
  {
    name: 'Sprachmemos',
    desc: 'iOS · eingebaut',
    url: 'https://support.apple.com/de-ch/guide/voice-memos/welcome/mac',
    oss: false,
  },
  {
    name: 'Recorder by Google',
    desc: 'Android · Pixel / Play Store',
    url: 'https://play.google.com/store/apps/details?id=com.google.android.apps.recorder',
    oss: false,
  },
];
...
const TRANSCRIBE_TOOLS: ToolLink[] = [
  {
    name: 'whisper.cpp',
    desc: 'Lokal, CPU/GPU · läuft auf Linux/Mac/Win · MIT-Lizenz',
    url: 'https://github.com/ggerganov/whisper.cpp',
    oss: true,
  },
  {
    name: 'faster-whisper',
    desc: 'Lokal, Python · GPU-optimiert · MIT',
    url: 'https://github.com/SYSTRAN/faster-whisper',
    oss: true,
  },
  {
    name: 'Vosk',
    desc: 'Lokal · offline, kleiner Footprint · Apache 2.0',
    url: 'https://alphacephei.com/vosk/',
    oss: true,
  },
  {
    name: 'Whisper (Original)',
    desc: 'Lokal, OpenAI-Modell, MIT-Code · Modell-Gewichte gratis',
    url: 'https://github.com/openai/whisper',
    oss: true,
  },
  {
    name: 'Speaches (Web-UI)',
    desc: 'Selbstgehostet · OpenAI-API-kompatibel · MIT',
...
const STRUCTURE_TOOLS: ToolLink[] = [
  {
    name: 'Ollama',
    desc: 'Lokaler LLM-Runner · Mistral, Llama, Qwen, etc. · MIT',
    url: 'https://ollama.com/',
    oss: true,
  },
  {
    name: 'llama.cpp',
    desc: 'Lokal, CPU/GPU · MIT-Lizenz',
    url: 'https://github.com/ggerganov/llama.cpp',
    oss: true,
  },
  {
    name: 'LM Studio',
    desc: 'Desktop-App · Linux/Mac/Win · gratis (closed source)',
    url: 'https://lmstudio.ai/',
    oss: false,
  },
  {
    name: 'Mistral / Llama / Qwen',
    desc: 'Open-Weight-Modelle für lokale Inferenz',
...
export function CaptureAlternatives() {
  ...
  return (
    <details className="mt-6 border-t border-subtle pt-5">
      ...
      <p className="mt-4 text-sm text-text-secondary max-w-2xl">{t('subtitle')}</p>
