  ...
  return (
    <div className={`flex flex-col gap-4 ${className}`}>
      ...
      <div className="card-shell p-4 sm:p-6">
        ...
        {state === 'idle' && (
          <div
            className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
              isDragging ? 'border-action bg-action-muted' : 'border-default'
            }`}
          ...
          >
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="text-text-secondary mb-2">{t('dragOrText')}</p>
              ...
              <p className="text-xs text-text-tertiary dark:text-text-tertiary">{t('fileHint')}</p>
            </div>
        ...
        {(state === 'preview' || state === 'analyzing' || state === 'success') && imagePreview && (
          <div className="space-y-4">
            {/* Image preview */}
            <div className="relative">
              <div className="relative w-full aspect-video bg-surface-raised rounded-lg overflow-hidden">
                <Image src={imagePreview} alt={t('imageAlt')} fill className="object-contain" />
              </div>
              <Button
                type="button"
                variant="destructive"
            ...
            <div className="flex items-center justify-center gap-3">
              {state === 'preview' && (
                <>
                  ...
                  <Button type="button" onClick={analyzeWithAI} variant="primary">
