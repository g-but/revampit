...
export function PaymentReturnBanner({ namespace, cleanPath }: Props) {
    ...
    return (
      <div className="bg-action-muted border border-strong rounded-lg p-4 mb-6 flex items-center justify-between gap-3">
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className="text-action text-lg leading-none"
  ...
  return (
    <div
      className={`border rounded-lg p-4 mb-6 flex items-center justify-between gap-3 ${
        isCancelled
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <p
          className={`font-medium ${isCancelled ? 'text-warning-800 dark:text-warning-300' : 'text-error-800 dark:text-error-400'}`}
        >
