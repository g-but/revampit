  ...
  return (
    <div className="rounded-lg border border-neutral-200 bg-surface-raised p-4">
      ...
      <p className="mt-0.5 text-xs text-text-tertiary">
        Öffnet den Rapport ohne Login — zum Weitergeben an die Begleitperson. Jederzeit
        deaktivierbar.
      </p>
      ...
      {token ? (
        <div className="mt-3 space-y-2">
          ...
          <Button
            ...
            onClick={revoke}
            disabled={busy}
            className="inline-flex items-center gap-1.5 px-0 text-text-tertiary hover:text-error-600"
          >
