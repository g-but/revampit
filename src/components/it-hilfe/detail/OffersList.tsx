            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center ${offer.repairerProfile ? 'bg-action-muted' : 'bg-surface-overlay'}`}
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {offer.repairerProfile?.isVerified && (
                        <CheckCircle
                          ...
                          aria-label={t('verifiedTechnicianLabel')}
                        />
                      )}
                    </div>
                    {offer.repairerProfile ? (
                        ...
                        {Number(offer.repairerProfile.averageRating) > 0 && (
                          <span className="flex items-center gap-0.5 text-text-tertiary">
                            ...
                            <span className="text-text-muted">
                              ({offer.repairerProfile.totalReviews})
                            </span>
                          </span>
                        )}
                      </div>
