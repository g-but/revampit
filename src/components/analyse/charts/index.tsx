...
function ChartLoading() {
  return (
    <div className="h-[380px] animate-pulse rounded-xl border bg-surface-base" aria-hidden="true" />
  );
}
...
export const TrendBarChart = dynamic(() => import('./TrendBarChart').then((m) => m.TrendBarChart), {
  ssr: false,
