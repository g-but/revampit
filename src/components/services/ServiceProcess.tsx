  ...
  return (
    <Section density="default" tone="tinted" contained={false}>
      <div className="container mx-auto px-4 sm:px-6">
        <h2
          className={cn(
            'text-2xl sm:text-3xl font-bold mb-8 sm:mb-12 text-center',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {process.map((step, index) => (
            <div key={index} className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-action text-action-text rounded-full flex items-center justify-center text-lg sm:text-xl font-bold mx-auto mb-3 sm:mb-4">
                {step.step}
              </div>
              <h3
                className={cn(
