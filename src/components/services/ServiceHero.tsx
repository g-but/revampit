  ...
  return (
    <Section density="default" tone="surface" className="border-b border-subtle">
      <div className="max-w-3xl">
        ...
        <Heading
          level={1}
          className="mt-3 text-3xl font-semibold leading-tight text-text-primary sm:text-4xl md:text-4xl lg:text-4xl"
        >
          {hero.title}
        </Heading>
        <Heading
          level={2}
          className="mt-4 text-lg font-medium leading-relaxed text-text-secondary sm:text-xl"
        >
          {hero.subtitle}
        </Heading>
