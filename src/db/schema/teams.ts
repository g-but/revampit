...
export const teams = pgTable(
  ...
  (table) => [index('idx_teams_active').on(table.isActive)],
);
...
export const teamGoals = pgTable(
  ...
  (table) => [index('idx_team_goals_team').on(table.teamId, table.sortOrder)],
);
...
export const teamMetrics = pgTable(
  ...
  (table) => [index('idx_team_metrics_team').on(table.teamId, table.sortOrder)],
);
