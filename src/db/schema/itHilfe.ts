...
export const itHilfeRequests = pgTable(
  'it_hilfe_requests',
  {
    ...
    preferredTechnicianId: uuid('preferred_technician_id').references(() => repairerProfiles.id, {
      onDelete: 'set null',
    }),
...
export const itHilfeOffers = pgTable(
  'it_hilfe_offers',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    requestId: uuid('request_id')
      .notNull()
      .references(() => itHilfeRequests.id, { onDelete: 'cascade' }),
