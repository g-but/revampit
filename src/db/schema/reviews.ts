...
export const reviews = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('reviews_reviewer_target_booking_unique').on(
      table.reviewerId,
      table.targetType,
      table.targetId,
      table.bookingId,
...
export const reviewAttachments = pgTable(
  ...
  (table) => [index('idx_review_attachments_review_id').on(table.reviewId)],
);
...
export const reviewModerationLog = pgTable(
