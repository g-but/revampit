...
export const projects = pgTable(
  'projects',
  {
    ...
    taskProjectId: uuid('task_project_id').references(() => taskProjects.id, {
      onDelete: 'set null',
    }),
...
export const projectNeeds = pgTable(
  'project_needs',
  {
    id: uuid('id').primaryKey().defaultRandom(),
  ...
  (table) => [index('idx_project_needs_project').on(table.projectId)],
);
