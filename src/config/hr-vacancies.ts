  ...
  volunteer: [
    {
      ...
      description: 'Kurzes Kennenlernen und Zugang zu Tools klären.',
      category: 'other',
    },
    {
      title: 'Erste Schicht planen',
      description: 'Verfügbarkeit mit Team abstimmen.',
      category: 'other',
    },
  ],
  intern: [
    {
      ...
      description: 'Lernziele und Betreuungsperson festhalten.',
      category: 'other',
    },
    {
      title: 'Werkstatt-Rundgang',
      description: 'Sicherheit und Abläufe vor Ort.',
      category: 'other',
    },
  ],
  employee: [
    {
      title: 'Arbeitsvertrag & Zugänge',
      description: 'Vertrag, E-Mail, Admin-Berechtigungen.',
      category: 'other',
    },
    {
      title: 'Erste Woche Planung',
      description: 'Einarbeitung mit Vorgesetzter.',
      category: 'other',
    },
  ],
  reintegration: [
    {
      title: 'Wiedereinstieg Gespräch',
      description: 'Erwartungen, Tempo und Unterstützung klären.',
      category: 'other',
    },
    {
      title: 'Buddy zuweisen',
      description: 'Ansprechperson für erste 90 Tage.',
      category: 'other',
    },
  ],
  contractor: [
    {
      ...
      description: 'Scope, Lieferobjekte und Kommunikation.',
      category: 'other',
    },
  ],
};
