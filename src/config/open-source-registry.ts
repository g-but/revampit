...
export const MATURITY_CONFIG: Record<Maturity, { label: string; color: string }> = {
  established: { label: 'Etabliert', color: 'bg-success-100 dark:bg-success-900/30 text-success-800 dark:text-success-300' },
...
export const MIGRATION_DIFFICULTY_CONFIG: Record<MigrationDifficulty, { label: string; color: string; description: string }> = {
  easy: { label: 'Einfach', color: 'bg-success-100 dark:bg-success-900/30 text-success-800 dark:text-success-300', description: 'Direkter Umstieg, kaum Einarbeitung nötig' },
