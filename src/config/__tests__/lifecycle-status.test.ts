...
import { INVOICE_STATUS, INVOICE_STATUS_LABELS, getInvoiceStatusLabel } from '../invoice-status';
...
import { REPORT_STATUS, REPORT_STATUS_LABELS, getReportStatusLabel } from '../report-status';
