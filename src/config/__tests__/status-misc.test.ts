...
import { getReportStatusLabel, REPORT_STATUS } from '../report-status';

import { getLocationStatusLabel, LOCATION_STATUS } from '../location-status';
...
import { REPAIRER_STATUS, REPAIRER_STATUS_LABELS } from '../repairer-status';
