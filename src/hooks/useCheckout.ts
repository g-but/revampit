...
export function useCheckout(initialListing: ListingForCheckout, errors: CheckoutErrors) {
  ...
  const shippingCost =
    deliveryMethod === 'shipping' && listing.shipping_cost_chf ? listing.shipping_cost_chf : 0;
