...
vi.mock('@/db/schema', () => ({
  listingReports: {
    ...
    details: 'lr_details',
    status: 'lr_status',
    createdAt: 'lr_createdAt',
    reviewedAt: 'lr_reviewedAt',
    resolutionNotes: 'lr_resNotes',
    resolutionAction: 'lr_resAction',
...
const MOCK_ROWS = [{ id: 'rep-1', reason: 'spam', status: 'pending', listing_title: 'Laptop' }];
