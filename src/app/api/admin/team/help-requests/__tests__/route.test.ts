...
const mockValidateHelpRequestFilter = vi.fn();
const mockValidateCreateHelpRequest = vi.fn();
...
vi.mock('@/db/schema', () => ({
  helpRequests: {
    id: 'hr_id',
    requesterId: 'hr_requesterId',
    title: 'hr_title',
    description: 'hr_description',
    category: 'hr_category',
    urgency: 'hr_urgency',
    requestedUserId: 'hr_requestedUserId',
    isBroadcast: 'hr_isBroadcast',
    status: 'hr_status',
    resolvedBy: 'hr_resolvedBy',
    resolvedAt: 'hr_resolvedAt',
    resolutionNotes: 'hr_resolutionNotes',
    createdAt: 'hr_createdAt',
    updatedAt: 'hr_updatedAt',
  },
...
vi.mock('@/lib/schemas/activity', () => ({
  validateHelpRequestFilter: (...args: unknown[]) =>
    mockValidateHelpRequestFilter.apply(null, args),
  validateCreateHelpRequest: (...args: unknown[]) =>
    mockValidateCreateHelpRequest.apply(null, args),
}));
