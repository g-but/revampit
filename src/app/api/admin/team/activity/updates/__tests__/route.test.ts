...
const mockValidateCreateActivityUpdate = vi.fn();
...
vi.mock('@/db/schema', () => ({
  activityUpdates: {
    id: 'au_id',
    userId: 'au_userId',
    updateType: 'au_updateType',
    title: 'au_title',
    description: 'au_description',
    category: 'au_category',
    visibility: 'au_visibility',
    occurredAt: 'au_occurredAt',
    createdAt: 'au_createdAt',
    updatedAt: 'au_updatedAt',
  },
...
vi.mock('@/lib/schemas/activity', () => ({
  activityStreamFilterSchema: {
    safeParse: (...args: unknown[]) => mockSafeParse.apply(null, args),
  },
  validateCreateActivityUpdate: (...args: unknown[]) =>
    mockValidateCreateActivityUpdate.apply(null, args),
}));
