...
const CreateSchema = z.object({
  ...
  scope: z
    .enum([
      PROMO_CODE_SCOPES.ALL,
      PROMO_CODE_SCOPES.MARKETPLACE,
      PROMO_CODE_SCOPES.MEMBERSHIP,
      PROMO_CODE_SCOPES.WORKSHOP,
      PROMO_CODE_SCOPES.SERVICE,
    ])
...
export const POST = withAdmin(
  'promo-codes',
  async (request: NextRequest, session: ValidSession) => {
    try {
