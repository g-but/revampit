...
const MOCK_OVERVIEW = {
  ...
  avg_processing_time_minutes: 1.5,
};
const MOCK_ESCROW = {
  total_escrows: '5',
  active_escrows: '3',
  released_escrows: '2',
  total_escrow_amount_cents: 10000,
  total_released_amount_cents: 5000,
};
const MOCK_REFUND = {
  total_refunds: '2',
  completed_refunds: '1',
  pending_refunds: '1',
  total_refund_amount_cents: 3000,
};
const MOCK_DISPUTE = {
  total_disputes: '1',
  open_disputes: '1',
  lost_disputes: '0',
  total_dispute_amount_cents: 2000,
};
