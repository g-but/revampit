...
jest.mock('@/db/schema', () => ({
  itHilfeRequests: {
    ...
    description: 'r_desc',
    urgency: 'r_urgency',
    budgetType: 'r_budgetType',
    budgetAmountCents: 'r_budget',
    postalCode: 'r_postalCode',
    city: 'r_city',
    canton: 'r_canton',
    serviceType: 'r_serviceType',
    skillsNeeded: 'r_skills',
    imageUrls: 'r_images',
    status: 'r_status',
    matchedOfferId: 'r_matchedOffer',
    offerCount: 'r_offerCount',
    serviceCategory: 'r_serviceCategory',
    aiDiagnosis: 'r_aiDiagnosis',
    adminNotes: 'r_adminNotes',
    expiresAt: 'r_expiresAt',
  ...
  itHilfeOffers: {
    ...
    message: 'o_message',
    status: 'o_status',
    estimatedTime: 'o_estimatedTime',
    proposedCompensation: 'o_proposedComp',
    createdAt: 'o_createdAt',
    helperId: 'o_helperId',
    requestId: 'o_requestId',
  },
...
jest.mock('@/config/error-messages', () => ({
  ERROR_MESSAGES: {
    ...
    IT_HILFE_REQUEST_NOT_FOUND: 'Nicht gefunden',
  },
}));
