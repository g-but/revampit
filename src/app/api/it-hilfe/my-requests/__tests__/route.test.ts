...
vi.mock('@/db/schema', () => ({
  itHilfeRequests: {
    ...
    categoryId: 'ihr_catId',
    deviceBrand: 'ihr_brand',
    deviceModel: 'ihr_model',
    title: 'ihr_title',
    description: 'ihr_desc',
    urgency: 'ihr_urgency',
    budgetType: 'ihr_budget',
    budgetAmountCents: 'ihr_budgetCents',
    postalCode: 'ihr_postal',
    city: 'ihr_city',
    canton: 'ihr_canton',
    serviceType: 'ihr_service',
    skillsNeeded: 'ihr_skills',
    imageUrls: 'ihr_images',
    status: 'ihr_status',
    matchedOfferId: 'ihr_matched',
    offerCount: 'ihr_offerCount',
    expiresAt: 'ihr_expires',
    createdAt: 'ihr_created',
    updatedAt: 'ihr_updated',
  },
}));
