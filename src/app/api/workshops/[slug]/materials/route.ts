...
export async function GET(request: NextRequest, { params }: { params: Promise<{ slug: string }> }) {
  try {
    ...
    let accessLevel: (typeof WORKSHOP_MATERIAL_ACCESS_TYPE)[keyof typeof WORKSHOP_MATERIAL_ACCESS_TYPE] =
    ...
    const accessTypes =
      accessLevel === WORKSHOP_MATERIAL_ACCESS_TYPE.ATTENDED
        ? [
            WORKSHOP_MATERIAL_ACCESS_TYPE.PUBLIC,
            WORKSHOP_MATERIAL_ACCESS_TYPE.REGISTERED,
            WORKSHOP_MATERIAL_ACCESS_TYPE.ATTENDED,
          ]
        : accessLevel === WORKSHOP_MATERIAL_ACCESS_TYPE.REGISTERED
          ? [WORKSHOP_MATERIAL_ACCESS_TYPE.PUBLIC, WORKSHOP_MATERIAL_ACCESS_TYPE.REGISTERED]
          : [WORKSHOP_MATERIAL_ACCESS_TYPE.PUBLIC];
