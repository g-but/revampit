...
vi.mock('@/db/schema', () => ({
  sellerProfiles: {
    ...
    totalListings: 'sp_totalListings',
...
vi.mock('@/lib/services/seller-service', () => ({
  sellerProfileCoreFields: {
    id: 'sp_id',
    user_id: 'sp_userId',
    display_name: 'sp_displayName',
    bio: 'sp_bio',
    avatar_url: 'sp_avatarUrl',
    city: 'sp_city',
    canton: 'sp_canton',
    is_verified: 'sp_isVerified',
    average_rating: 'sp_averageRating',
    total_reviews: 'sp_totalReviews',
    total_listings: 'sp_totalListings',
    total_sold: 'sp_totalSold',
    created_at: 'sp_createdAt',
  },
}));
...
const MOCK_PROFILE = {
  id: 'sp-1',
  user_id: 'user-seller',
  display_name: 'Max Verkäufer',
  bio: 'Ich verkaufe refurbished Hardware.',
  avatar_url: null,
  city: 'Zürich',
  canton: 'ZH',
  is_verified: false,
