...
vi.mock('@/db/schema', () => ({
  ...
  locationBookings: {
    ...
    eventType: 'lb_eventType',
    eventId: 'lb_eventId',
    title: 'lb_title',
    description: 'lb_description',
    startTime: 'lb_startTime',
    endTime: 'lb_endTime',
    expectedAttendees: 'lb_expectedAttendees',
    specialRequirements: 'lb_specialRequirements',
    status: 'lb_status',
  },
...
function makeRequest(
  method = 'GET',
  body?: unknown,
  url = 'http://localhost/api/locations/loc-1/bookings',
) {
  ...
  mockLimit.mockResolvedValue([
    {
      ...
      bookedByEmail: 'user@example.com',
      locationName: 'RevampIT Zürich',
    },
  ]);
