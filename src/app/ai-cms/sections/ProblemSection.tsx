  ...
  const problems = [
    {
      ...
      description:
        'Nutzer finden einen Fehler, öffnen aber keine E-Mail. Der Fehler bleibt unbemerkt.',
    },
    {
    ...
    <section className="py-16 px-4 bg-surface-base">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-text-secondary text-center mb-12 max-w-2xl mx-auto">
          Traditionelle Rückmeldewege — E-Mail, Kontaktformular, Ticket-System — haben alle
          denselben Nachteil: sie trennen Kontext vom Problem.
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          {problems.map((p) => (
            <div
              key={p.title}
              className="bg-error-50 dark:bg-error-900/20 border border-error-100 dark:border-error-800/30 rounded-lg p-6"
            >
