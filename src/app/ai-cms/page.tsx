...
export const metadata: Metadata = {
  ...
  description:
    'Unser Verbesserungssystem ermöglicht es Nutzern, direkt auf jeder Seite Feedback zu geben. Eine moderne Alternative zu herkömmlichen Content-Management-Systemen.',
  keywords: [
    'Website Feedback',
    'Content Management',
    'User Feedback',
