    ...
    >
            ...
            return (
              ...
              >
                ...
                <span className="flex items-center gap-2">
                  ...
                  {!count.failed && (
                    <span
                      className={`text-sm font-medium ${count.pending > 0 ? 'text-warning-600 dark:text-warning-400' : 'text-text-muted'}`}
                    >
      ...
      <div className="p-6 bg-surface-raised border border-subtle rounded-xl">
        <p className="text-sm text-text-secondary">
          <strong>Hinweis:</strong> Workshop-Vorschläge und Blog-Artikel von Mitgliedern müssen hier
          geprüft und freigegeben werden, bevor sie öffentlich sichtbar sind.
          {isSuper &&
            ' Berechtigungsanfragen von Teammitgliedern können nur von Super-Admins bearbeitet werden.'}
        </p>
      </div>
    </AdminPageWrapper>
  );
