...
function makeStubTranslator() {
  const fakeT = (key: string, params?: Record<string, unknown>): string => {
    ...
    switch (key) {
      case 'hero.kpis.total':
        return 'Total';
      case 'hero.kpis.inProgress':
        return 'In Bearbeitung';
      case 'hero.kpis.failed':
        return 'Fehlgeschlagen';
      case 'hero.kpis.ready':
        return 'Bereit';
      case 'hero.kpis.published':
        return 'Publiziert';
      ...
      case 'hero.failed.cta':
        return 'Fehlgeschlagene anzeigen';
      ...
      case 'hero.inProgress.cta':
        return 'In Bearbeitung anzeigen';
      case 'hero.empty.headline':
        return 'Pipeline ist leer';
      case 'hero.empty.sub':
        return 'Sobald ein Gerät reinkommt, taucht es hier auf. Erfasse das erste.';
      case 'hero.empty.cta':
        return 'Neues Gerät erfassen';
      case 'hero.healthy.headline':
        return 'Pipeline im grünen Bereich.';
