            ...
            {teams.map((t) => (
              ...
              >
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <span
                    className={`shrink-0 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${getAccentClasses(t.accent)}`}
                  >
                ...
                {t.purpose && (
                  <p className="text-sm text-text-secondary line-clamp-2 mb-3">{t.purpose}</p>
                )}
