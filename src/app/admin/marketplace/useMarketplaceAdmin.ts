...
export function useMarketplaceAdmin() {
  ...
  const [editData, setEditData] = useState<{ admin_notes: string; status: string }>({
    admin_notes: '',
    status: '',
  });
  ...
  const refreshStats = useCallback(() => {
    apiFetch<Stats>('/api/admin/marketplace/stats').then((r) => {
  ...
  const fetchListings = useCallback(async () => {
    ...
    const result = await apiFetch<PaginatedResponse<ListingRow>>(
      `/api/admin/marketplace?${params}`,
    );
  ...
  const fetchReports = useCallback(async () => {
    ...
    const result = await apiFetch<PaginatedResponse<ReportRow>>(
      `/api/admin/marketplace/reports?${params}`,
    );
  ...
  const fetchOrders = useCallback(async () => {
    ...
    const result = await apiFetch<PaginatedResponse<OrderRow>>(
      `/api/admin/marketplace/orders?${params}`,
    );
  ...
  const fetchQuestions = useCallback(async () => {
    ...
    const result = await apiFetch<PaginatedResponse<QuestionRow>>(
      `/api/admin/marketplace/questions?${params}`,
    );
