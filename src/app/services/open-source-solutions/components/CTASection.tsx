...
export function CTASection() {
  return (
    <section className="py-16 sm:py-20 bg-action text-action-text">
      <div className="container mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto text-white/90">
          Schliessen Sie sich Tausenden von Einzelpersonen und Unternehmen an, die erfolgreich auf
          Open-Source-Lösungen umgestiegen sind. Unser Expertenteam ist bereit, Ihnen beim Wechsel
          zu helfen.
        </p>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="bg-surface-base/10 rounded-lg p-4 sm:p-6 border-2 border-white/20">
              <h4 className={cn('text-lg sm:text-xl font-semibold mb-2', 'text-white')}>
                Expertenberatung
              </h4>
              <p className="text-white/90 text-sm sm:text-base">
                Professionelle Unterstützung für Ihre Open-Source-Reise
              </p>
            </div>
            <div className="bg-surface-base/10 rounded-lg p-4 sm:p-6 border-2 border-white/20">
              <h4 className={cn('text-lg sm:text-xl font-semibold mb-2', 'text-white')}>
              ...
              <p className="text-white/90 text-sm sm:text-base">
                Zugeschnitten auf Ihre spezifischen Bedürfnisse und Anforderungen
              </p>
            </div>
            <div className="bg-surface-base/10 rounded-lg p-4 sm:p-6 border-2 border-white/20">
              <h4 className={cn('text-lg sm:text-xl font-semibold mb-2', 'text-white')}>
