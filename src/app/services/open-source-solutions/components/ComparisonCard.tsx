  ...
  return (
    <div
      className={cn(
        ...
        isOpenSource ? 'bg-success-50 border-success-200' : 'bg-surface-raised border',
      )}
    >
        ...
        <div>
          <h5
            className={cn(
              ...
              getTextColor(isOpenSource ? 'success' : 'neutral', 'primary'),
            )}
          >
            {item.name}
          </h5>
              ...
              <li key={i} className="flex items-start">
                ...
                <span
                  className={cn(
                    ...
                    getTextColor(isOpenSource ? 'success' : 'neutral', 'muted'),
                  )}
                >
                  {example}
                </span>
