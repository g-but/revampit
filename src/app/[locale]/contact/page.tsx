      ...
      <Section density="default" tone="surface" contained={false}>
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <Heading level={2} className="ui-public-display-md mt-3 sr-only">
              {t('hero.title')}
            </Heading>
          </div>
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 max-w-md mx-auto">
            {contactInfo.map((info, index) => (
              <article
                key={index}
                className="ui-public-card text-center bg-action-muted/30 border-action/20"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <Heading level={2} className="ui-public-display-md mb-6 text-center">
                {t('form.title')}
              </Heading>
            </div>
            <ContactForm />
