          ...
          <Card className="p-6 sm:p-8">
            {status.isMember ? (
              <div className="text-center">
                ...
                <Heading level={2} className="ui-public-display-md mb-2">
                  {t('member.title')}
                </Heading>
                ...
                {status.memberSince && (
                  <p className="ui-public-meta mt-2 mb-6">
                    {t('member.since', {
                      date: new Date(status.memberSince).toLocaleDateString(locale),
                    })}
                  </p>
                )}
              ...
              <>
                <div className="text-center mb-6">
                  <Heading level={2} className="ui-public-display-md">
                    {t('form.heading')}
                  </Heading>
