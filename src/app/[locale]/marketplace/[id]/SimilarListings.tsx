            ...
            >
              <div className="relative aspect-4/3">
                ...
                <div className="absolute top-2 left-2">
                  <span
                    className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${simCondition.color}`}
                  >
                    {simCondition.label}
                  </span>
                </div>
              ...
              <div className="p-3">
                <Heading
                  level={3}
                  className="text-text-primary mb-1 line-clamp-2 text-sm group-hover:text-action transition-colors"
                >
                  {sim.title}
                </Heading>
