  ...
  return (
    <main className="min-h-screen">
      <PageHero
        ...
        icon={project.icon}
        title={project.name}
        subtitle={t(`items.${slug}.tagline` as never)}
      />
              ...
              <div className="flex flex-col gap-3">
                {project.liveUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-action hover:underline underline-offset-2"
                  >
                ...
                {project.license && (
                  <span className="inline-flex items-center gap-2 text-text-secondary">
                    ...
                    {t('detail.license', { license: project.license })}
                  </span>
                )}
              </div>
            </div>
