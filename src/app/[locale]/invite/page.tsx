  ...
  return (
    <PageShell maxWidth="2xl" py="py-12 sm:py-16">
      ...
      <div className="text-center mb-10">
        ...
        <Heading level={1} className="text-3xl sm:text-4xl mb-3">
          {t('title')}
        </Heading>
        <p className="text-text-secondary text-lg">{t('subtitle', { orgName: ORG.name })}</p>
      </div>
      ...
      <Card className="p-6 mb-6">
        ...
        {loading ? (
          ...
          <div className="flex gap-2">
            <Input readOnly value={data?.url ?? ''} className="flex-1 font-mono truncate" />
      ...
      <Card className="p-6 mb-6">
        ...
        {feedback && (
          <p
            className={`mt-3 text-sm ${feedback.type === 'success' ? 'text-action' : 'text-error-600'}`}
          >
            {feedback.message}
          </p>
        )}
