...
describe('workshopRegistrationStatusUpdate', () => {
  it('subject says "bestätigt" for confirmed', () => {
    const email = workshopRegistrationStatusUpdate(
      'Kai',
      'Python Workshop',
      '2026-05-20',
      'confirmed',
...
describe('workshopCancellation', () => {
  it('returns { subject, html, text }', () => {
    const email = workshopCancellation(
      'Sara',
      'Git Workshop',
      '2026-04-10',
      'Bern',
...
describe('workshopFeedbackRequest', () => {
  ...
  it('html contains the feedback URL', () => {
    expect(
      workshopFeedbackRequest('Lena', 'Open Source', '2026-05-01', feedbackUrl).html,
    ).toContain(feedbackUrl);
  });
...
describe('workshopProposalSubmitted', () => {
  ...
  it('html contains the workshop title', () => {
    expect(workshopProposalSubmitted('Tom', 'Docker for Beginners', 'PROP-123').html).toContain(
...
describe('workshopProposalChangesRequested', () => {
  it('returns { subject, html, text }', () => {
    const email = workshopProposalChangesRequested(
      'Eva',
      'Kubernetes Workshop',
      'Bitte Beispiele ergänzen',
    );
    expect(email).toHaveProperty('subject');
    expect(email).toHaveProperty('html');
    expect(email).toHaveProperty('text');
