...
export async function updateVacancy(
  ...
  if (data.application_deadline !== undefined)
    patch.applicationDeadline = data.application_deadline;
  if (data.compensation_public_text !== undefined)
    patch.compensationPublicText = data.compensation_public_text;
  if (data.hiring_manager_user_id !== undefined)
    patch.hiringManagerUserId = data.hiring_manager_user_id;
