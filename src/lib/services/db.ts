...
export async function updateServiceType(
  ...
  try {
    ...
    if (data.requires_approval !== undefined)
      addClause('requires_approval', data.requires_approval);
    ...
    if (data.features_json !== undefined)
      addClause('features_json', JSON.stringify(data.features_json), true);
    if (data.process_json !== undefined)
      addClause('process_json', JSON.stringify(data.process_json), true);
    if (data.pricing_base !== undefined) addClause('pricing_base', data.pricing_base);
    if (data.pricing_details !== undefined)
      addClause('pricing_details', JSON.stringify(data.pricing_details), true);
    if (data.pricing_media_prices !== undefined)
      addClause('pricing_media_prices', JSON.stringify(data.pricing_media_prices), true);
