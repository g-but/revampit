...
const applicationStatusSchema = z.enum(
  APPLICATION_STATUS_OPTIONS as unknown as [string, ...string[]],
);
const applicationSourceSchema = z.enum(
  APPLICATION_SOURCE_OPTIONS as unknown as [string, ...string[]],
);
...
export const createVacancySchema = z.object({
  ...
  department: z
    .enum(DEPARTMENT_OPTIONS as unknown as [string, ...string[]])
    .optional()
    .nullable(),
