    ...
    <div className={`ai-cms-admin-dashboard ${className}`} style={style}>
      ...
      {showStats && stats && (
        <div className="ai-cms-stats-grid">
          ...
          <div className="ai-cms-stat-card">
            <h3>Pending</h3>
            <p className="ai-cms-stat-number text-yellow-600">
              {stats.byStatus[SuggestionStatus.PENDING]}
            </p>
          </div>
          <div className="ai-cms-stat-card">
            <h3>In Progress</h3>
            <p className="ai-cms-stat-number text-blue-600">
              {stats.byStatus[SuggestionStatus.IN_PROGRESS]}
            </p>
          </div>
          <div className="ai-cms-stat-card">
            <h3>Completed</h3>
            <p className="ai-cms-stat-number text-green-600">
          ...
          <div className="ai-cms-filter-row">
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((prev) => ({
                  ...prev,
                  status: (e.target.value as SuggestionStatus) || undefined,
                }))
              }
            ...
            <select
              value={filters.page || ''}
              onChange={(e) =>
                setFilters((prev) => ({ ...prev, page: e.target.value || undefined }))
              }
              className="ai-cms-filter-select"
            >
          ...
          filteredSuggestions.map((suggestion) => (
            ...
            >
              ...
              <div className="ai-cms-suggestion-content">
                ...
                {suggestion.contact && (
                  <p className="ai-cms-suggestion-contact">Contact: {suggestion.contact}</p>
                )}
              </div>
      ...
      {suggestions.length >= pageSize && (
        <div className="ai-cms-pagination">
          ...
          <span className="ai-cms-pagination-info">Page {currentPage}</span>
          <button
