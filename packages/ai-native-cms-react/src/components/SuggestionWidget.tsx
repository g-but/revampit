  ...
  const renderModal = () => {
    ...
    return (
      <div className={`ai-cms-modal-overlay ${getThemeClass()}`}>
        <div ref={modalRef} className="ai-cms-modal-content" style={modalStyle}>
          {submitted ? (
            <div className="ai-cms-success-message">
              ...
              <p className="ai-cms-success-text">Your suggestion has been sent to our team.</p>
            </div>
          ) : (
            <>
              <div className="ai-cms-modal-header">
                <h3 className="ai-cms-modal-title">Suggest an Edit</h3>
                <button onClick={closeModal} className="ai-cms-close-button" aria-label="Close">
              ...
              <form onSubmit={handleSubmit} className="ai-cms-form">
                ...
                {error && <div className="ai-cms-error-message">{error}</div>}
